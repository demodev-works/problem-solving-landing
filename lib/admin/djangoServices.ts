...
export const noticeService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/notices/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/notices/${id}/`, data),
...
export const popupService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/notifications/popups/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/notifications/popups/${id}/`, data),
  delete: (id: number) =>
    apiClient.delete(`/admin/notifications/popups/${id}/`),
};
...
export const userService = {
  ...
  update: (id: string, data: Record<string, unknown>) => apiClient.put(`/admin/users/${id}/`, data),
...
export const problemService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/problems/', data),
  update: (id: number, data: Record<string, unknown>) =>
  ...
  uploadExcel: async (formData: FormData) => {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/problems/upload/`,
      {
        method: 'POST',
        headers: {
...
export const progressService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/progress/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/progress/${id}/`, data),
...
export const subjectService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/curriculum/subjects/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/curriculum/subjects/${id}/`, data),
...
export const majorService = {
  ...
  create: (data: Record<string, unknown>) =>
    apiClient.post('/admin/curriculum/prepare-majors/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/curriculum/prepare-majors/${id}/`, data),
  delete: (id: number) =>
    apiClient.delete(`/admin/curriculum/prepare-majors/${id}/`),
};
...
export const inquiryService = {
  ...
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/supports/inquiries/${id}/`, data),
...
export const qnaService = {
  ...
  answer: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/questions/${id}/answer/`, data),
...
export const memoProgressService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/memo-progress/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/memo-progress/${id}/`, data),
...
export const memoProblemService = {
  ...
  create: (data: Record<string, unknown>) => apiClient.post('/admin/memo-problems/', data),
  update: (id: number, data: Record<string, unknown>) =>
    apiClient.put(`/admin/memo-problems/${id}/`, data),
  ...
  uploadExcel: async (formData: FormData) => {
    const token =
      typeof window !== 'undefined'
        ...
        : null;
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/admin/memo-problems/upload/`,
      {
        method: 'POST',
        headers: {
          ...(token && { Authorization: `Bearer ${token}` }),
