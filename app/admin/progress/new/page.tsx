...
import { createProgress } from '@/lib/admin/problemService';
import { getSubjectsWithDetails } from '@/lib/admin/subjectService';
...
export default function NewProgressPage() {
  ...
  const fetchSubjects = async () => {
    try {
      const subjectsData = await getSubjectsWithDetails();
      setSubjects(
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                value={subjectId}
                onChange={(e) =>
                  setSubjectId(e.target.value ? parseInt(e.target.value) : '')
                }
                className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                required
              >
